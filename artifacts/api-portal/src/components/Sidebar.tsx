import { Power, Home, BarChart3, Boxes, Cable, ScrollText } from "lucide-react";
...
export default function Sidebar({
  tab, setTab, online, baseUrl, apiKey
}: {
  tab: Tab; setTab: (t: Tab) => void; online: boolean | null; baseUrl: string; apiKey: string;
}) {
  return (
    <aside className="fixed inset-y-0 left-0 w-[240px] bg-surface/80 backdrop-blur-xl border-r border-border flex flex-col z-10 shadow-[4px_0_24px_rgba(0,0,0,0.2)]">
